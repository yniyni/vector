                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Login Dulu Dongs!</h1>
                                    </div>
                                    <form  action="proses_login.php" method="post">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                id="username" name="username" 
                                                placeholder="Masukan Username" requaires="required">
                                        </div>
                                        <div class="form-group">
...
<style>
	...
	.bg-login-image2 {
  background: url("../assets/img/espresoo.jpg");
